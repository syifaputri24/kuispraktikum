 ...
 * @author hp
 */
public class Designer extends InputNilai implements Perhitungan {
   public Designer (String nama, int tesX, int tesY, int tesZ){
    ...
    public double NilaiTotal() {
         return (0.4 * super.tesX) + (0.45 * super.tesY) + (0.25 * super.tesZ);
    }
